...
test.describe('Flowchart - Interaction Modes', () => {
  test('zoom controls are visible and functional', async ({ page }) => {
    await page.goto(storyUrl('components-flowchart--default'));
  ...
  test('zoom in button increases scale', async ({ page }) => {
    ...
    const root = page.locator('.glyph-flowchart-root').first();
  ...
  test('modifier-key mode story has interaction overlay initially hidden', async ({ page }) => {
    await page.goto(storyUrl('components-flowchart--modifier-key-mode'));
  ...
  test('click-to-activate mode story shows overlay when inactive', async ({ page }) => {
    await page.goto(storyUrl('components-flowchart--click-to-activate-mode'));
  ...
  test('click-to-activate mode activates on click', async ({ page }) => {
    ...
    const container = page.locator('.glyph-flowchart-container').first();
  ...
  test('always mode story has no interaction restrictions', async ({ page }) => {
    await page.goto(storyUrl('components-flowchart--always-mode'));
