...
- [**Markdown Syntax**](/authoring-guide) — Learn about all supported Markdown features and the `ui:` block authoring syntax.
- [**Components**](/components) — Browse the full library of built-in components: Callout, Tabs, Steps, Table, Graph, Chart, Relation, and Timeline.
- [**IR Spec**](/reference/ir-spec) — Understand the structure of the compiled Intermediate Representation.
- [**Plugin API**](/reference/plugin-api) — Register custom components and extend the runtime.
- [**Theming**](/reference/theming) — Customize colors, typography, and spacing across your documents.
