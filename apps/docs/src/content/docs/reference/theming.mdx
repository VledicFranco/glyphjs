...
**Tier 1 — 53 semantic tokens (required by TypeScript).**
These are the building blocks: colors, accent, spacing, radius, effects, semantic states, and a shared color palette. Set these in your theme object and every component gets correct colors automatically.
